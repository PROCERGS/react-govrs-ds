...
:host {
  ...
  --barra-estado-link-color: #e4e4e4;
  --barra-estado-link-hover-color: #ffffff;
  --barra-estado-link-active-color: #e4e4e4;
  --barra-estado-highlight-color: #ffffff;
  --barra-estado-toggle-color: #bcbcbb;
  --barra-estado-toggle-hover-color: #ffffff;
  --barra-estado-font-family: Roboto, Arial, sans-serif;
  --barra-estado-font-size-mobile: 14px;
  --barra-estado-font-size-desktop: 11px;
  --barra-estado-link-padding-mobile: 13px 40px;
  --barra-estado-link-padding-desktop: 9px 13px;
  --barra-estado-guria-link-padding-desktop: 7px 13px;
}
...
.barra-estado {
  height: var(--barra-estado-height);
  background-color: var(--barra-estado-background);
}
...
.barra-estado__menu {
  ...
  padding: 14px 0 20px;
  margin: 0;
  font-family: var(--barra-estado-font-family);
...
.barra-estado__menu > li > a {
  display: block;
  height: auto;
  padding: var(--barra-estado-link-padding-mobile);
  color: var(--barra-estado-link-color);
  font-size: var(--barra-estado-font-size-mobile);
  font-weight: 400;
  line-height: 1;
  text-decoration: none;
  transition: box-shadow 0.25s linear, color 0.25s linear;
...
.barra-estado__menu > li > a:visited {
  color: var(--barra-estado-link-color) !important;
}

.barra-estado__menu > li > a:focus,
.barra-estado__menu > li > a:hover {
  color: var(--barra-estado-link-hover-color);
  box-shadow: inset 5px 0 var(--barra-estado-highlight-color);
}

.barra-estado__menu > li > a:active {
  color: var(--barra-estado-link-active-color) !important;
}
...
.barra-estado__menu > li > a:hover svg path,
.barra-estado__menu > li > a:focus svg path {
  fill: var(--barra-estado-link-hover-color);
}
...
@media only screen and (min-width: 992px) {
  ...
  .barra-estado__menu > li > a.barra-estado__guria-link {
    padding: var(--barra-estado-guria-link-padding-desktop);
  }
...
:host-context(.high-contrast) .barra-estado__menu > li > a:visited,
:host-context(.high-contrast) .barra-estado__menu > li > a:hover,
:host-context(.high-contrast) .barra-estado__menu > li > a:focus {
...
`
  ...
  var RS_GOV_SVG = `
<svg version="1.1" id="rs-gov-br" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="77px" height="16px"
     viewBox="0 0 77 16" enable-background="new 0 0 77 16" xml:space="preserve">
...
`
  ...
  var GURIA_SVG = `
<svg id="GurIA" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="49.94px" height="13.21px" viewBox="0 0 49.94 13.21" enable-background="new 0 0 49.94 13.21" xml:space="preserve">
  <title>GurIA</title>
  <desc>A tua nova assistente digital</desc>
...
`
  ...
  var MENU_ITEMS = [
    ...
    },
    {
      ...
      label: 'Central do Cidad&atilde;o'
    },
    {
    ...
    },
    {
      ...
      label: 'Secretarias e &Oacute;rg&atilde;os'
    },
    {
      href: 'https://www.diariooficial.rs.gov.br/',
      label: 'Di&aacute;rio Oficial'
    },
    {
      href: 'https://www.rs.gov.br/guria',
      className: 'barra-estado__guria-link',
  ...
  function ensureWindowOrigin() {
    ...
    if (!window.location.origin) {
      try {
        ...
        // Ignora erro em navegadores que não permitem escrita em window.location.origin
      }
    }
  }

  function removeExistingLegacyBars() {
    if (typeof document === 'undefined') return

    var legacyBars = document.querySelectorAll('.barra-estado')
    Array.prototype.forEach.call(legacyBars, function (element) {
      element.remove()
    })

    var legacyContainers = document.querySelectorAll('.container-menu')
    Array.prototype.forEach.call(legacyContainers, function (element) {
      if (!element.closest('[' + HOST_ATTR + '="true"]')) {
        element.remove()
      }
    })
  }
  ...
  function renderMenuItem(item) {
    var className = item.className ? ' class="' + item.className + '"' : ''
    var content = item.html || '<span class="sr-only">Estado </span>' + item.label
  ...
  function renderMarkup(toggleId) {
    ...
    return [
      ...
      '<a class="barra-estado__logo" title="rs.gov" href="https://www.rs.gov.br/">',
      RS_GOV_SVG,
      '</a>',
      ...
      ' data-open="&bull;&bull;&bull;"',
      ' data-close="&bull;&bull;&bull;"',
      ' tabindex="0"',
      ' role="button"',
      ' aria-expanded="false"',
      ...
      '<ul class="barra-estado__menu" id="', toggleId, '-menu" aria-label="Links institucionais do Estado">',
      menuItemsHtml,
      '</ul>',
  ...
  function bindToggleBehavior(renderRoot, toggleId) {
    ...
    toggle.addEventListener('keydown', function (event) {
      ...
      if ((key === 'Escape' || key === 'Esc' || key === 27) && checkbox.checked) {
        event.preventDefault()
        checkbox.checked = false
