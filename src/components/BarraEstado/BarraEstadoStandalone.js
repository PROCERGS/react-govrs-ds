// /* ========================= Código teste 23/06 web component ========================== */
// (function () {
//   'use strict';
...
//       } catch (error) {
//         // silencioso por compatibilidade com browsers legados
//       }
//     }
//   }
...
//       label: 'Central do Cidadão'
//     },
//     {
//       href: 'http://www.transparencia.rs.gov.br/',
//       label: 'Transparência'
//     },
//     {
...
//     toggleSequence += 1;
//     return 'barra-estado__toggle-' + Date.now() + '-' + toggleSequence;
//   }
...
//       if (key === 'Escape' && checkbox.checked) {
//         event.preventDefault();
...
//   function removeLegacyBarraEstado() {
...
(function () {
  document.addEventListener("DOMContentLoaded", initBarraEstado);

  function initBarraEstado() {
    removeExisting();
    ensureOrigin();
    injectStyles();
    injectHTML();
  ...
  function removeExisting() {
    document.querySelectorAll(".barra-estado").forEach(el => el.remove());
  }
  ...
  function injectStyles() {
    const css = `@import url(//fonts.googleapis.com/css?family=Roboto);
body{-webkit-animation:bugfix infinite 1s}
@-webkit-keyframes bugfix{from,to{padding:0}}
#barra-estado__toggle,.barra-estado__toggle{display:none}
.barra-estado__menu>li{list-style:none;float:left}
@media only screen and (max-width:991px){
.barra-estado__menu{display:none;opacity:0;width:280px;position:absolute;right:0;top:32px;z-index:999}
.barra-estado__menu>li{display:block;width:100%;margin:0}
.barra-estado__menu>li>a{display:block;width:100%;text-decoration:none;box-sizing:border-box}
.barra-estado__toggle{display:block;position:relative;cursor:pointer;user-select:none}
#barra-estado__toggle:checked~.barra-estado__menu{display:block;opacity:1}}
.barra-estado{height:32px;background-color:#4f4f4f}
.barra-estado__container{position:relative;padding:0 15px;margin:auto;height:100%;}
.barra-estado__logo{position:absolute;width:77px;height:16px;margin-top:6px;left:15px;}
.barra-estado__menu{font-family:Roboto,Arial,sans-serif;text-transform:uppercase;background:#737474;border-top:1px solid #fff;margin-top:0;padding:14px 0 20px}
.barra-estado__nav{display:block;float:right}
.barra-estado__menu>li>a{display:block;font-weight:400;padding:13px 40px;font-size:14px;color:#e4e4e4}
.barra-estado__menu>li>a:hover{box-shadow:inset 5px 0 #fff;color:#fff}
@media only screen and (min-width:992px){
.barra-estado__menu{background:none;border-top:none;padding:0;margin-top:0}
.barra-estado__menu>li>a{padding:9px 13px;font-size:11px}
.barra-estado__menu>li>a:hover{box-shadow:inset 0 2px #fff}}
...
<div class="barra-estado">
  <div class="barra-estado__container">
    <a class="barra-estado__logo" href="https://www.rs.gov.br/" title="rs.gov">
      <svg width="77" height="16" viewBox="0 0 77 16">
        <path fill="#fff" d="M5.64,6.15c-1.8,0-2.92,1.09-2.92,3.4v3.55H0V3.48H2.73v1.94c.56-1.32,1.45-2.19,3.07-2.12v2.85Z"/>
      </svg>
    </a>
    ...
    <div class="barra-estado__nav">
      <div class="barra-estado__nav__form">
        ...
        <label for="barra-estado__toggle" class="barra-estado__toggle"
          data-open="•••" data-close="•••"></label>

        <ul class="barra-estado__menu">
          <li><a href="https://estado.rs.gov.br/agencia-de-noticias">Notícias</a></li>
          <li><a href="https://www.rs.gov.br/">Serviços</a></li>
          <li><a href="https://www.centraldocidadao.rs.gov.br/">Central do Cidadão</a></li>
          <li><a href="http://www.transparencia.rs.gov.br/">Transparência</a></li>
          <li><a href="https://estado.rs.gov.br/institucional">Secretarias</a></li>
          <li><a href="https://www.diariooficial.rs.gov.br/">Diário Oficial</a></li>
          <li><a href="https://www.rs.gov.br/guria">GurIA</a></li>
        </ul>
      </div>
    </div>
  </div>
