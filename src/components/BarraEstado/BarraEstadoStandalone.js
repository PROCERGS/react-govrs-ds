...
//     .barra-estado__container { display:flex; justify-content:space-between; align-items:center; padding:0 15px; }
//     .barra-estado__menu { list-style:none; display:flex; margin:0; padding:0; gap:10px; }
//     .barra-estado__menu a { text-decoration:none; font-size:12px; font-weight:bold; color:#1a7235; }
//   `;
...
//           <a href="https://www.rs.gov.br/" target="_blank">
//             RS.GOV
//           </a>
...
//               <li>.rs.gov.br/">Central</a></li>
//               <li>parencia.rs.gov.br/">Transparência</a></li>
//             </ul>
//           </div>
...
//     wrapper.innerHTML = getHTML(toggleId);
...
`;
  ...
  function removeLegacyBarraEstado() {
    ...
    /*
     * Remove possíveis barras antigas de produção.
